...
(function(global, factory) { /* global define, require, module */
    ...
    $root.CSGOInterpolationInfoPB = (function() {
    
        /**
         * Properties of a CSGOInterpolationInfoPB.
         * @exports ICSGOInterpolationInfoPB
         * @interface ICSGOInterpolationInfoPB
         * @property {number|null} [srcTick] CSGOInterpolationInfoPB srcTick
         * @property {number|null} [dstTick] CSGOInterpolationInfoPB dstTick
         * @property {number|null} [frac] CSGOInterpolationInfoPB frac
         */
    
        /**
         * Constructs a new CSGOInterpolationInfoPB.
         * @exports CSGOInterpolationInfoPB
         * @classdesc Represents a CSGOInterpolationInfoPB.
         * @implements ICSGOInterpolationInfoPB
         * @constructor
         * @param {ICSGOInterpolationInfoPB=} [properties] Properties to set
         */
         ...
         * @member {number} srcTick
         * @memberof CSGOInterpolationInfoPB
         * @instance
         */
        CSGOInterpolationInfoPB.prototype.srcTick = -1;
    
        /**
         * CSGOInterpolationInfoPB dstTick.
         * @member {number} dstTick
         * @memberof CSGOInterpolationInfoPB
         * @instance
         */
        CSGOInterpolationInfoPB.prototype.dstTick = -1;
         ...
         * @instance
         */
        CSGOInterpolationInfoPB.prototype.frac = 0;
         ...
         * @static
         * @param {ICSGOInterpolationInfoPB=} [properties] Properties to set
         * @returns {CSGOInterpolationInfoPB} CSGOInterpolationInfoPB instance
         */
        CSGOInterpolationInfoPB.create = function create(properties) {
            return new CSGOInterpolationInfoPB(properties);
        };
         ...
         * @memberof CSGOInterpolationInfoPB
         * @static
         * @param {ICSGOInterpolationInfoPB} message CSGOInterpolationInfoPB message or plain object to encode
        ...
        CSGOInterpolationInfoPB.encode = function encode(message, writer) {
            ...
            if (message.srcTick != null && Object.hasOwnProperty.call(message, "srcTick"))
                writer.uint32(/* id 1, wireType 0 =*/8).int32(message.srcTick);
            if (message.dstTick != null && Object.hasOwnProperty.call(message, "dstTick"))
                writer.uint32(/* id 2, wireType 0 =*/16).int32(message.dstTick);
         ...
         */
        CSGOInterpolationInfoPB.decode = function decode(reader, length) {
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CSGOInterpolationInfoPB.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
        ...
        CSGOInterpolationInfoPB.verify = function verify(message) {
            ...
            if (message.srcTick != null && message.hasOwnProperty("srcTick"))
                if (!$util.isInteger(message.srcTick))
                    return "srcTick: integer expected";
            if (message.dstTick != null && message.hasOwnProperty("dstTick"))
                if (!$util.isInteger(message.dstTick))
                    return "dstTick: integer expected";
        ...
        CSGOInterpolationInfoPB.fromObject = function fromObject(object) {
            ...
            if (object.srcTick != null)
                message.srcTick = object.srcTick | 0;
            if (object.dstTick != null)
                message.dstTick = object.dstTick | 0;
            if (object.frac != null)
         ...
         * @memberof CSGOInterpolationInfoPB
         * @static
         * @param {CSGOInterpolationInfoPB} message CSGOInterpolationInfoPB
        ...
        CSGOInterpolationInfoPB.toObject = function toObject(message, options) {
            ...
            if (message.srcTick != null && message.hasOwnProperty("srcTick"))
                object.srcTick = message.srcTick;
            if (message.dstTick != null && message.hasOwnProperty("dstTick"))
                object.dstTick = message.dstTick;
            if (message.frac != null && message.hasOwnProperty("frac"))
         ...
         */
        CSGOInterpolationInfoPB.prototype.toJSON = function toJSON() {
         ...
         */
        CSGOInterpolationInfoPB.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/CSGOInterpolationInfoPB";
        };
    
        return CSGOInterpolationInfoPB;
    })();
    
    $root.CSGOInputHistoryEntryPB = (function() {
    
        /**
         * Properties of a CSGOInputHistoryEntryPB.
         * @exports ICSGOInputHistoryEntryPB
         * @interface ICSGOInputHistoryEntryPB
         * @property {ICMsgQAngle|null} [viewAngles] CSGOInputHistoryEntryPB viewAngles
         * @property {number|null} [renderTickCount] CSGOInputHistoryEntryPB renderTickCount
         * @property {number|null} [renderTickFraction] CSGOInputHistoryEntryPB renderTickFraction
         * @property {number|null} [playerTickCount] CSGOInputHistoryEntryPB playerTickCount
         * @property {number|null} [playerTickFraction] CSGOInputHistoryEntryPB playerTickFraction
         * @property {ICSGOInterpolationInfoPB|null} [clInterp] CSGOInputHistoryEntryPB clInterp
         * @property {ICSGOInterpolationInfoPB|null} [svInterp0] CSGOInputHistoryEntryPB svInterp0
         * @property {ICSGOInterpolationInfoPB|null} [svInterp1] CSGOInputHistoryEntryPB svInterp1
         * @property {ICSGOInterpolationInfoPB|null} [playerInterp] CSGOInputHistoryEntryPB playerInterp
         * @property {number|null} [frameNumber] CSGOInputHistoryEntryPB frameNumber
         * @property {number|null} [targetEntIndex] CSGOInputHistoryEntryPB targetEntIndex
         * @property {ICMsgVector|null} [shootPosition] CSGOInputHistoryEntryPB shootPosition
         * @property {ICMsgVector|null} [targetHeadPosCheck] CSGOInputHistoryEntryPB targetHeadPosCheck
         * @property {ICMsgVector|null} [targetAbsPosCheck] CSGOInputHistoryEntryPB targetAbsPosCheck
         * @property {ICMsgQAngle|null} [targetAbsAngCheck] CSGOInputHistoryEntryPB targetAbsAngCheck
         */
    
        /**
         * Constructs a new CSGOInputHistoryEntryPB.
         * @exports CSGOInputHistoryEntryPB
         * @classdesc Represents a CSGOInputHistoryEntryPB.
         * @implements ICSGOInputHistoryEntryPB
         * @constructor
         * @param {ICSGOInputHistoryEntryPB=} [properties] Properties to set
         */
         ...
         * @memberof CSGOInputHistoryEntryPB
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.viewAngles = null;
    
        /**
         * CSGOInputHistoryEntryPB renderTickCount.
         * @member {number} renderTickCount
         * @memberof CSGOInputHistoryEntryPB
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.renderTickCount = 0;
    
        /**
         * CSGOInputHistoryEntryPB renderTickFraction.
         * @member {number} renderTickFraction
         * @memberof CSGOInputHistoryEntryPB
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.renderTickFraction = 0;
    
        /**
         * CSGOInputHistoryEntryPB playerTickCount.
         * @member {number} playerTickCount
         * @memberof CSGOInputHistoryEntryPB
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.playerTickCount = 0;
    
        /**
         * CSGOInputHistoryEntryPB playerTickFraction.
         * @member {number} playerTickFraction
         * @memberof CSGOInputHistoryEntryPB
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.playerTickFraction = 0;
    
        /**
         * CSGOInputHistoryEntryPB clInterp.
         * @member {ICSGOInterpolationInfoPB|null|undefined} clInterp
         * @memberof CSGOInputHistoryEntryPB
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.clInterp = null;
    
        /**
         * CSGOInputHistoryEntryPB svInterp0.
         * @member {ICSGOInterpolationInfoPB|null|undefined} svInterp0
         * @memberof CSGOInputHistoryEntryPB
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.svInterp0 = null;
    
        /**
         * CSGOInputHistoryEntryPB svInterp1.
         * @member {ICSGOInterpolationInfoPB|null|undefined} svInterp1
         * @memberof CSGOInputHistoryEntryPB
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.svInterp1 = null;
    
        /**
         * CSGOInputHistoryEntryPB playerInterp.
         * @member {ICSGOInterpolationInfoPB|null|undefined} playerInterp
         * @memberof CSGOInputHistoryEntryPB
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.playerInterp = null;
         ...
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.frameNumber = 0;
    
        /**
         * CSGOInputHistoryEntryPB targetEntIndex.
         * @member {number} targetEntIndex
         * @memberof CSGOInputHistoryEntryPB
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.targetEntIndex = -1;
    
        /**
         * CSGOInputHistoryEntryPB shootPosition.
         * @member {ICMsgVector|null|undefined} shootPosition
         * @memberof CSGOInputHistoryEntryPB
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.shootPosition = null;
    
        /**
         * CSGOInputHistoryEntryPB targetHeadPosCheck.
         * @member {ICMsgVector|null|undefined} targetHeadPosCheck
         * @memberof CSGOInputHistoryEntryPB
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.targetHeadPosCheck = null;
    
        /**
         * CSGOInputHistoryEntryPB targetAbsPosCheck.
         * @member {ICMsgVector|null|undefined} targetAbsPosCheck
         * @memberof CSGOInputHistoryEntryPB
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.targetAbsPosCheck = null;
    
        /**
         * CSGOInputHistoryEntryPB targetAbsAngCheck.
         * @member {ICMsgQAngle|null|undefined} targetAbsAngCheck
         * @memberof CSGOInputHistoryEntryPB
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.targetAbsAngCheck = null;
         ...
         * @static
         * @param {ICSGOInputHistoryEntryPB=} [properties] Properties to set
         * @returns {CSGOInputHistoryEntryPB} CSGOInputHistoryEntryPB instance
         */
        CSGOInputHistoryEntryPB.create = function create(properties) {
            return new CSGOInputHistoryEntryPB(properties);
        };
         ...
         * @memberof CSGOInputHistoryEntryPB
         * @static
         * @param {ICSGOInputHistoryEntryPB} message CSGOInputHistoryEntryPB message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        CSGOInputHistoryEntryPB.encode = function encode(message, writer) {
            ...
            if (message.viewAngles != null && Object.hasOwnProperty.call(message, "viewAngles"))
                $root.CMsgQAngle.encode(message.viewAngles, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            if (message.shootPosition != null && Object.hasOwnProperty.call(message, "shootPosition"))
                $root.CMsgVector.encode(message.shootPosition, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
            if (message.renderTickCount != null && Object.hasOwnProperty.call(message, "renderTickCount"))
                writer.uint32(/* id 4, wireType 0 =*/32).int32(message.renderTickCount);
            if (message.renderTickFraction != null && Object.hasOwnProperty.call(message, "renderTickFraction"))
                writer.uint32(/* id 5, wireType 5 =*/45).float(message.renderTickFraction);
            if (message.playerTickCount != null && Object.hasOwnProperty.call(message, "playerTickCount"))
                writer.uint32(/* id 6, wireType 0 =*/48).int32(message.playerTickCount);
            if (message.playerTickFraction != null && Object.hasOwnProperty.call(message, "playerTickFraction"))
                writer.uint32(/* id 7, wireType 5 =*/61).float(message.playerTickFraction);
            if (message.targetEntIndex != null && Object.hasOwnProperty.call(message, "targetEntIndex"))
                writer.uint32(/* id 8, wireType 0 =*/64).int32(message.targetEntIndex);
            if (message.targetHeadPosCheck != null && Object.hasOwnProperty.call(message, "targetHeadPosCheck"))
                $root.CMsgVector.encode(message.targetHeadPosCheck, writer.uint32(/* id 9, wireType 2 =*/74).fork()).ldelim();
            if (message.targetAbsPosCheck != null && Object.hasOwnProperty.call(message, "targetAbsPosCheck"))
                $root.CMsgVector.encode(message.targetAbsPosCheck, writer.uint32(/* id 10, wireType 2 =*/82).fork()).ldelim();
            if (message.targetAbsAngCheck != null && Object.hasOwnProperty.call(message, "targetAbsAngCheck"))
                $root.CMsgQAngle.encode(message.targetAbsAngCheck, writer.uint32(/* id 11, wireType 2 =*/90).fork()).ldelim();
            if (message.clInterp != null && Object.hasOwnProperty.call(message, "clInterp"))
                $root.CSGOInterpolationInfoPB.encode(message.clInterp, writer.uint32(/* id 12, wireType 2 =*/98).fork()).ldelim();
            if (message.svInterp0 != null && Object.hasOwnProperty.call(message, "svInterp0"))
                $root.CSGOInterpolationInfoPB.encode(message.svInterp0, writer.uint32(/* id 13, wireType 2 =*/106).fork()).ldelim();
            if (message.svInterp1 != null && Object.hasOwnProperty.call(message, "svInterp1"))
                $root.CSGOInterpolationInfoPB.encode(message.svInterp1, writer.uint32(/* id 14, wireType 2 =*/114).fork()).ldelim();
            if (message.playerInterp != null && Object.hasOwnProperty.call(message, "playerInterp"))
                $root.CSGOInterpolationInfoPB.encode(message.playerInterp, writer.uint32(/* id 15, wireType 2 =*/122).fork()).ldelim();
            if (message.frameNumber != null && Object.hasOwnProperty.call(message, "frameNumber"))
                writer.uint32(/* id 20, wireType 0 =*/160).int32(message.frameNumber);
            return writer;
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CSGOInputHistoryEntryPB.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            ...
            while (reader.pos < end) {
                ...
                case 12: {
                        message.clInterp = $root.CSGOInterpolationInfoPB.decode(reader, reader.uint32());
                        break;
                    }
                case 13: {
                        message.svInterp0 = $root.CSGOInterpolationInfoPB.decode(reader, reader.uint32());
                        break;
                    }
                case 14: {
                        message.svInterp1 = $root.CSGOInterpolationInfoPB.decode(reader, reader.uint32());
                        break;
                    }
                case 15: {
                        message.playerInterp = $root.CSGOInterpolationInfoPB.decode(reader, reader.uint32());
                        break;
                    }
                case 20: {
                ...
                case 3: {
                        message.shootPosition = $root.CMsgVector.decode(reader, reader.uint32());
                        break;
                    }
                case 9: {
                        message.targetHeadPosCheck = $root.CMsgVector.decode(reader, reader.uint32());
                        break;
                    }
                case 10: {
                        message.targetAbsPosCheck = $root.CMsgVector.decode(reader, reader.uint32());
                        break;
                    }
                case 11: {
                        message.targetAbsAngCheck = $root.CMsgQAngle.decode(reader, reader.uint32());
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CSGOInputHistoryEntryPB.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        CSGOInputHistoryEntryPB.verify = function verify(message) {
            ...
            if (message.renderTickCount != null && message.hasOwnProperty("renderTickCount"))
                if (!$util.isInteger(message.renderTickCount))
                    return "renderTickCount: integer expected";
            if (message.renderTickFraction != null && message.hasOwnProperty("renderTickFraction"))
                if (typeof message.renderTickFraction !== "number")
                    return "renderTickFraction: number expected";
            if (message.playerTickCount != null && message.hasOwnProperty("playerTickCount"))
                if (!$util.isInteger(message.playerTickCount))
                    return "playerTickCount: integer expected";
            if (message.playerTickFraction != null && message.hasOwnProperty("playerTickFraction"))
                if (typeof message.playerTickFraction !== "number")
                    return "playerTickFraction: number expected";
            if (message.clInterp != null && message.hasOwnProperty("clInterp")) {
                var error = $root.CSGOInterpolationInfoPB.verify(message.clInterp);
                if (error)
                    return "clInterp." + error;
            }
            if (message.svInterp0 != null && message.hasOwnProperty("svInterp0")) {
                var error = $root.CSGOInterpolationInfoPB.verify(message.svInterp0);
                if (error)
                    return "svInterp0." + error;
            }
            if (message.svInterp1 != null && message.hasOwnProperty("svInterp1")) {
                var error = $root.CSGOInterpolationInfoPB.verify(message.svInterp1);
                if (error)
                    return "svInterp1." + error;
            }
            if (message.playerInterp != null && message.hasOwnProperty("playerInterp")) {
                var error = $root.CSGOInterpolationInfoPB.verify(message.playerInterp);
                if (error)
                    return "playerInterp." + error;
            }
            ...
            if (message.targetEntIndex != null && message.hasOwnProperty("targetEntIndex"))
                if (!$util.isInteger(message.targetEntIndex))
                    return "targetEntIndex: integer expected";
            if (message.shootPosition != null && message.hasOwnProperty("shootPosition")) {
                var error = $root.CMsgVector.verify(message.shootPosition);
                if (error)
                    return "shootPosition." + error;
            }
            if (message.targetHeadPosCheck != null && message.hasOwnProperty("targetHeadPosCheck")) {
                var error = $root.CMsgVector.verify(message.targetHeadPosCheck);
                if (error)
                    return "targetHeadPosCheck." + error;
            }
            if (message.targetAbsPosCheck != null && message.hasOwnProperty("targetAbsPosCheck")) {
                var error = $root.CMsgVector.verify(message.targetAbsPosCheck);
                if (error)
                    return "targetAbsPosCheck." + error;
            }
            if (message.targetAbsAngCheck != null && message.hasOwnProperty("targetAbsAngCheck")) {
                var error = $root.CMsgQAngle.verify(message.targetAbsAngCheck);
                if (error)
                    return "targetAbsAngCheck." + error;
            }
            return null;
        };
        ...
        CSGOInputHistoryEntryPB.fromObject = function fromObject(object) {
            ...
            if (object.viewAngles != null) {
                if (typeof object.viewAngles !== "object")
                    throw TypeError(".CSGOInputHistoryEntryPB.viewAngles: object expected");
                message.viewAngles = $root.CMsgQAngle.fromObject(object.viewAngles);
            }
            if (object.renderTickCount != null)
                message.renderTickCount = object.renderTickCount | 0;
            if (object.renderTickFraction != null)
                message.renderTickFraction = Number(object.renderTickFraction);
            if (object.playerTickCount != null)
                message.playerTickCount = object.playerTickCount | 0;
            if (object.playerTickFraction != null)
                message.playerTickFraction = Number(object.playerTickFraction);
            if (object.clInterp != null) {
                if (typeof object.clInterp !== "object")
                    throw TypeError(".CSGOInputHistoryEntryPB.clInterp: object expected");
                message.clInterp = $root.CSGOInterpolationInfoPB.fromObject(object.clInterp);
            }
            if (object.svInterp0 != null) {
                if (typeof object.svInterp0 !== "object")
                    throw TypeError(".CSGOInputHistoryEntryPB.svInterp0: object expected");
                message.svInterp0 = $root.CSGOInterpolationInfoPB.fromObject(object.svInterp0);
            }
            if (object.svInterp1 != null) {
                if (typeof object.svInterp1 !== "object")
                    throw TypeError(".CSGOInputHistoryEntryPB.svInterp1: object expected");
                message.svInterp1 = $root.CSGOInterpolationInfoPB.fromObject(object.svInterp1);
            }
            if (object.playerInterp != null) {
                if (typeof object.playerInterp !== "object")
                    throw TypeError(".CSGOInputHistoryEntryPB.playerInterp: object expected");
                message.playerInterp = $root.CSGOInterpolationInfoPB.fromObject(object.playerInterp);
            }
            if (object.frameNumber != null)
                message.frameNumber = object.frameNumber | 0;
            if (object.targetEntIndex != null)
                message.targetEntIndex = object.targetEntIndex | 0;
            if (object.shootPosition != null) {
                if (typeof object.shootPosition !== "object")
                    throw TypeError(".CSGOInputHistoryEntryPB.shootPosition: object expected");
                message.shootPosition = $root.CMsgVector.fromObject(object.shootPosition);
            }
            if (object.targetHeadPosCheck != null) {
                if (typeof object.targetHeadPosCheck !== "object")
                    throw TypeError(".CSGOInputHistoryEntryPB.targetHeadPosCheck: object expected");
                message.targetHeadPosCheck = $root.CMsgVector.fromObject(object.targetHeadPosCheck);
            }
            if (object.targetAbsPosCheck != null) {
                if (typeof object.targetAbsPosCheck !== "object")
                    throw TypeError(".CSGOInputHistoryEntryPB.targetAbsPosCheck: object expected");
                message.targetAbsPosCheck = $root.CMsgVector.fromObject(object.targetAbsPosCheck);
            }
            if (object.targetAbsAngCheck != null) {
                if (typeof object.targetAbsAngCheck !== "object")
                    throw TypeError(".CSGOInputHistoryEntryPB.targetAbsAngCheck: object expected");
                message.targetAbsAngCheck = $root.CMsgQAngle.fromObject(object.targetAbsAngCheck);
            }
            return message;
        };
         ...
         * @memberof CSGOInputHistoryEntryPB
         * @static
         * @param {CSGOInputHistoryEntryPB} message CSGOInputHistoryEntryPB
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        CSGOInputHistoryEntryPB.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                ...
                object.shootPosition = null;
                object.renderTickCount = 0;
                object.renderTickFraction = 0;
                object.playerTickCount = 0;
                object.playerTickFraction = 0;
                object.targetEntIndex = -1;
                object.targetHeadPosCheck = null;
                object.targetAbsPosCheck = null;
                object.targetAbsAngCheck = null;
                object.clInterp = null;
                object.svInterp0 = null;
                object.svInterp1 = null;
                object.playerInterp = null;
                object.frameNumber = 0;
            }
            if (message.viewAngles != null && message.hasOwnProperty("viewAngles"))
                object.viewAngles = $root.CMsgQAngle.toObject(message.viewAngles, options);
            if (message.shootPosition != null && message.hasOwnProperty("shootPosition"))
                object.shootPosition = $root.CMsgVector.toObject(message.shootPosition, options);
            if (message.renderTickCount != null && message.hasOwnProperty("renderTickCount"))
                object.renderTickCount = message.renderTickCount;
            if (message.renderTickFraction != null && message.hasOwnProperty("renderTickFraction"))
                object.renderTickFraction = options.json && !isFinite(message.renderTickFraction) ? String(message.renderTickFraction) : message.renderTickFraction;
            if (message.playerTickCount != null && message.hasOwnProperty("playerTickCount"))
                object.playerTickCount = message.playerTickCount;
            if (message.playerTickFraction != null && message.hasOwnProperty("playerTickFraction"))
                object.playerTickFraction = options.json && !isFinite(message.playerTickFraction) ? String(message.playerTickFraction) : message.playerTickFraction;
            if (message.targetEntIndex != null && message.hasOwnProperty("targetEntIndex"))
                object.targetEntIndex = message.targetEntIndex;
            if (message.targetHeadPosCheck != null && message.hasOwnProperty("targetHeadPosCheck"))
                object.targetHeadPosCheck = $root.CMsgVector.toObject(message.targetHeadPosCheck, options);
            if (message.targetAbsPosCheck != null && message.hasOwnProperty("targetAbsPosCheck"))
                object.targetAbsPosCheck = $root.CMsgVector.toObject(message.targetAbsPosCheck, options);
            if (message.targetAbsAngCheck != null && message.hasOwnProperty("targetAbsAngCheck"))
                object.targetAbsAngCheck = $root.CMsgQAngle.toObject(message.targetAbsAngCheck, options);
            if (message.clInterp != null && message.hasOwnProperty("clInterp"))
                object.clInterp = $root.CSGOInterpolationInfoPB.toObject(message.clInterp, options);
            if (message.svInterp0 != null && message.hasOwnProperty("svInterp0"))
                object.svInterp0 = $root.CSGOInterpolationInfoPB.toObject(message.svInterp0, options);
            if (message.svInterp1 != null && message.hasOwnProperty("svInterp1"))
                object.svInterp1 = $root.CSGOInterpolationInfoPB.toObject(message.svInterp1, options);
            if (message.playerInterp != null && message.hasOwnProperty("playerInterp"))
                object.playerInterp = $root.CSGOInterpolationInfoPB.toObject(message.playerInterp, options);
            if (message.frameNumber != null && message.hasOwnProperty("frameNumber"))
         ...
         * @returns {Object.<string,*>} JSON object
         */
        CSGOInputHistoryEntryPB.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
         ...
         * @returns {string} The default type url
         */
        CSGOInputHistoryEntryPB.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/CSGOInputHistoryEntryPB";
        };
    
        return CSGOInputHistoryEntryPB;
    })();
    
    $root.CSGOUserCmdPB = (function() {
    
        /**
         * Properties of a CSGOUserCmdPB.
         * @exports ICSGOUserCmdPB
         * @interface ICSGOUserCmdPB
         * @property {ICBaseUserCmdPB|null} [base] CSGOUserCmdPB base
         * @property {Array.<ICSGOInputHistoryEntryPB>|null} [inputHistory] CSGOUserCmdPB inputHistory
         * @property {number|null} [attack1StartHistoryIndex] CSGOUserCmdPB attack1StartHistoryIndex
         * @property {number|null} [attack2StartHistoryIndex] CSGOUserCmdPB attack2StartHistoryIndex
         * @property {number|null} [attack3StartHistoryIndex] CSGOUserCmdPB attack3StartHistoryIndex
         * @property {CSGOUserCmdPB.EWeaponDecision|null} [weaponDecision] CSGOUserCmdPB weaponDecision
         * @property {number|null} [weaponDecisionWeapon] CSGOUserCmdPB weaponDecisionWeapon
         * @property {CSGOUserCmdPB.EGrenadeStrength|null} [targetGrenadeStrength] CSGOUserCmdPB targetGrenadeStrength
         */
    
        /**
         * Constructs a new CSGOUserCmdPB.
         * @exports CSGOUserCmdPB
         * @classdesc Represents a CSGOUserCmdPB.
         * @implements ICSGOUserCmdPB
         * @constructor
         * @param {ICSGOUserCmdPB=} [properties] Properties to set
         */
        function CSGOUserCmdPB(properties) {
            this.inputHistory = [];
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
         ...
         * @memberof CSGOUserCmdPB
         * @instance
         */
        CSGOUserCmdPB.prototype.base = null;
    
        /**
         * CSGOUserCmdPB inputHistory.
         * @member {Array.<ICSGOInputHistoryEntryPB>} inputHistory
         * @memberof CSGOUserCmdPB
         * @instance
         */
        CSGOUserCmdPB.prototype.inputHistory = $util.emptyArray;
    
        /**
         * CSGOUserCmdPB attack1StartHistoryIndex.
         * @member {number} attack1StartHistoryIndex
         * @memberof CSGOUserCmdPB
         * @instance
         */
        CSGOUserCmdPB.prototype.attack1StartHistoryIndex = -1;
    
        /**
         * CSGOUserCmdPB attack2StartHistoryIndex.
         * @member {number} attack2StartHistoryIndex
         * @memberof CSGOUserCmdPB
         * @instance
         */
        CSGOUserCmdPB.prototype.attack2StartHistoryIndex = -1;
    
        /**
         * CSGOUserCmdPB attack3StartHistoryIndex.
         * @member {number} attack3StartHistoryIndex
         * @memberof CSGOUserCmdPB
         * @instance
         */
        CSGOUserCmdPB.prototype.attack3StartHistoryIndex = -1;
    
        /**
         * CSGOUserCmdPB weaponDecision.
         * @member {CSGOUserCmdPB.EWeaponDecision} weaponDecision
         * @memberof CSGOUserCmdPB
         * @instance
         */
        CSGOUserCmdPB.prototype.weaponDecision = 0;
    
        /**
         * CSGOUserCmdPB weaponDecisionWeapon.
         * @member {number} weaponDecisionWeapon
         * @memberof CSGOUserCmdPB
         * @instance
         */
        CSGOUserCmdPB.prototype.weaponDecisionWeapon = 0;
    
        /**
         * CSGOUserCmdPB targetGrenadeStrength.
         * @member {CSGOUserCmdPB.EGrenadeStrength} targetGrenadeStrength
         * @memberof CSGOUserCmdPB
         * @instance
         */
        CSGOUserCmdPB.prototype.targetGrenadeStrength = 0;
         ...
         * @static
         * @param {ICSGOUserCmdPB=} [properties] Properties to set
         * @returns {CSGOUserCmdPB} CSGOUserCmdPB instance
         */
        CSGOUserCmdPB.create = function create(properties) {
            return new CSGOUserCmdPB(properties);
        };
         ...
         * @memberof CSGOUserCmdPB
         * @static
         * @param {ICSGOUserCmdPB} message CSGOUserCmdPB message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        CSGOUserCmdPB.encode = function encode(message, writer) {
            ...
            if (message.inputHistory != null && message.inputHistory.length)
                for (var i = 0; i < message.inputHistory.length; ++i)
                    $root.CSGOInputHistoryEntryPB.encode(message.inputHistory[i], writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            if (message.attack1StartHistoryIndex != null && Object.hasOwnProperty.call(message, "attack1StartHistoryIndex"))
                writer.uint32(/* id 6, wireType 0 =*/48).int32(message.attack1StartHistoryIndex);
            if (message.attack2StartHistoryIndex != null && Object.hasOwnProperty.call(message, "attack2StartHistoryIndex"))
                writer.uint32(/* id 7, wireType 0 =*/56).int32(message.attack2StartHistoryIndex);
            if (message.attack3StartHistoryIndex != null && Object.hasOwnProperty.call(message, "attack3StartHistoryIndex"))
                writer.uint32(/* id 8, wireType 0 =*/64).int32(message.attack3StartHistoryIndex);
            if (message.weaponDecision != null && Object.hasOwnProperty.call(message, "weaponDecision"))
                writer.uint32(/* id 9, wireType 0 =*/72).int32(message.weaponDecision);
            if (message.weaponDecisionWeapon != null && Object.hasOwnProperty.call(message, "weaponDecisionWeapon"))
                writer.uint32(/* id 10, wireType 0 =*/80).int32(message.weaponDecisionWeapon);
            if (message.targetGrenadeStrength != null && Object.hasOwnProperty.call(message, "targetGrenadeStrength"))
                writer.uint32(/* id 11, wireType 0 =*/88).int32(message.targetGrenadeStrength);
            return writer;
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CSGOUserCmdPB.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            ...
            while (reader.pos < end) {
                ...
                case 2: {
                        if (!(message.inputHistory && message.inputHistory.length))
                            message.inputHistory = [];
                        message.inputHistory.push($root.CSGOInputHistoryEntryPB.decode(reader, reader.uint32()));
                        break;
                    }
                case 6: {
                ...
                case 9: {
                        message.weaponDecision = reader.int32();
                        break;
                    }
                case 10: {
                        message.weaponDecisionWeapon = reader.int32();
                        break;
                    }
                case 11: {
                        message.targetGrenadeStrength = reader.int32();
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CSGOUserCmdPB.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        CSGOUserCmdPB.verify = function verify(message) {
            ...
            if (message.inputHistory != null && message.hasOwnProperty("inputHistory")) {
                if (!Array.isArray(message.inputHistory))
                    return "inputHistory: array expected";
                for (var i = 0; i < message.inputHistory.length; ++i) {
                    var error = $root.CSGOInputHistoryEntryPB.verify(message.inputHistory[i]);
                    if (error)
                        return "inputHistory." + error;
                }
            }
            if (message.attack1StartHistoryIndex != null && message.hasOwnProperty("attack1StartHistoryIndex"))
                if (!$util.isInteger(message.attack1StartHistoryIndex))
                    return "attack1StartHistoryIndex: integer expected";
            if (message.attack2StartHistoryIndex != null && message.hasOwnProperty("attack2StartHistoryIndex"))
                if (!$util.isInteger(message.attack2StartHistoryIndex))
                    return "attack2StartHistoryIndex: integer expected";
            if (message.attack3StartHistoryIndex != null && message.hasOwnProperty("attack3StartHistoryIndex"))
                if (!$util.isInteger(message.attack3StartHistoryIndex))
                    return "attack3StartHistoryIndex: integer expected";
            if (message.weaponDecision != null && message.hasOwnProperty("weaponDecision"))
                switch (message.weaponDecision) {
                default:
                    return "weaponDecision: enum value expected";
                case 0:
                case 1:
                case 2:
                case 3:
            ...
            if (message.weaponDecisionWeapon != null && message.hasOwnProperty("weaponDecisionWeapon"))
                if (!$util.isInteger(message.weaponDecisionWeapon))
                    return "weaponDecisionWeapon: integer expected";
            if (message.targetGrenadeStrength != null && message.hasOwnProperty("targetGrenadeStrength"))
                switch (message.targetGrenadeStrength) {
                default:
                    return "targetGrenadeStrength: enum value expected";
                case 0:
                case 1:
                case 2:
                    break;
        ...
        CSGOUserCmdPB.fromObject = function fromObject(object) {
            ...
            if (object.inputHistory) {
                if (!Array.isArray(object.inputHistory))
                    throw TypeError(".CSGOUserCmdPB.inputHistory: array expected");
                message.inputHistory = [];
                for (var i = 0; i < object.inputHistory.length; ++i) {
                    if (typeof object.inputHistory[i] !== "object")
                        throw TypeError(".CSGOUserCmdPB.inputHistory: object expected");
                    message.inputHistory[i] = $root.CSGOInputHistoryEntryPB.fromObject(object.inputHistory[i]);
                }
            }
            if (object.attack1StartHistoryIndex != null)
                message.attack1StartHistoryIndex = object.attack1StartHistoryIndex | 0;
            if (object.attack2StartHistoryIndex != null)
                message.attack2StartHistoryIndex = object.attack2StartHistoryIndex | 0;
            if (object.attack3StartHistoryIndex != null)
                message.attack3StartHistoryIndex = object.attack3StartHistoryIndex | 0;
            switch (object.weaponDecision) {
            default:
                if (typeof object.weaponDecision === "number") {
                    message.weaponDecision = object.weaponDecision;
                    break;
                }
                break;
            case "k_eNone":
            case 0:
                message.weaponDecision = 0;
                break;
            case "k_ePrimaryAttack":
            case 1:
                message.weaponDecision = 1;
                break;
            case "k_eSecondaryAttack":
            case 2:
                message.weaponDecision = 2;
                break;
            case "k_eZoom":
            case 3:
                message.weaponDecision = 3;
                break;
            case "k_eReload":
            case 4:
                message.weaponDecision = 4;
                break;
            case "k_eGrenadeThrow":
            case 5:
                message.weaponDecision = 5;
                break;
            case "k_eGrenadeHold":
            case 6:
                message.weaponDecision = 6;
                break;
            case "k_eGrenadeHoldThenThrow":
            case 7:
                message.weaponDecision = 7;
                break;
            }
            if (object.weaponDecisionWeapon != null)
                message.weaponDecisionWeapon = object.weaponDecisionWeapon | 0;
            switch (object.targetGrenadeStrength) {
            default:
                if (typeof object.targetGrenadeStrength === "number") {
                    message.targetGrenadeStrength = object.targetGrenadeStrength;
                    break;
                }
                break;
            case "k_eLow":
            case 0:
                message.targetGrenadeStrength = 0;
                break;
            case "k_eMid":
            case 1:
                message.targetGrenadeStrength = 1;
                break;
            case "k_eHigh":
            case 2:
                message.targetGrenadeStrength = 2;
                break;
            }
            return message;
        };
         ...
         * @memberof CSGOUserCmdPB
         * @static
         * @param {CSGOUserCmdPB} message CSGOUserCmdPB
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        CSGOUserCmdPB.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                object.base = null;
                object.attack1StartHistoryIndex = -1;
                object.attack2StartHistoryIndex = -1;
                object.attack3StartHistoryIndex = -1;
                object.weaponDecision = options.enums === String ? "k_eNone" : 0;
                object.weaponDecisionWeapon = 0;
                object.targetGrenadeStrength = options.enums === String ? "k_eLow" : 0;
            }
            if (message.base != null && message.hasOwnProperty("base"))
                object.base = $root.CBaseUserCmdPB.toObject(message.base, options);
            if (message.inputHistory && message.inputHistory.length) {
                object.inputHistory = [];
                for (var j = 0; j < message.inputHistory.length; ++j)
                    object.inputHistory[j] = $root.CSGOInputHistoryEntryPB.toObject(message.inputHistory[j], options);
            }
            if (message.attack1StartHistoryIndex != null && message.hasOwnProperty("attack1StartHistoryIndex"))
                object.attack1StartHistoryIndex = message.attack1StartHistoryIndex;
            if (message.attack2StartHistoryIndex != null && message.hasOwnProperty("attack2StartHistoryIndex"))
                object.attack2StartHistoryIndex = message.attack2StartHistoryIndex;
            if (message.attack3StartHistoryIndex != null && message.hasOwnProperty("attack3StartHistoryIndex"))
                object.attack3StartHistoryIndex = message.attack3StartHistoryIndex;
            if (message.weaponDecision != null && message.hasOwnProperty("weaponDecision"))
                object.weaponDecision = options.enums === String ? $root.CSGOUserCmdPB.EWeaponDecision[message.weaponDecision] === undefined ? message.weaponDecision : $root.CSGOUserCmdPB.EWeaponDecision[message.weaponDecision] : message.weaponDecision;
            if (message.weaponDecisionWeapon != null && message.hasOwnProperty("weaponDecisionWeapon"))
                object.weaponDecisionWeapon = message.weaponDecisionWeapon;
            if (message.targetGrenadeStrength != null && message.hasOwnProperty("targetGrenadeStrength"))
                object.targetGrenadeStrength = options.enums === String ? $root.CSGOUserCmdPB.EGrenadeStrength[message.targetGrenadeStrength] === undefined ? message.targetGrenadeStrength : $root.CSGOUserCmdPB.EGrenadeStrength[message.targetGrenadeStrength] : message.targetGrenadeStrength;
            return object;
        };
         ...
         * @returns {Object.<string,*>} JSON object
         */
        CSGOUserCmdPB.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
         ...
         * @returns {string} The default type url
         */
        CSGOUserCmdPB.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/CSGOUserCmdPB";
        };
    
        /**
         * EWeaponDecision enum.
         * @name CSGOUserCmdPB.EWeaponDecision
         * @enum {number}
         * @property {number} k_eNone=0 k_eNone value
         * @property {number} k_ePrimaryAttack=1 k_ePrimaryAttack value
         * @property {number} k_eSecondaryAttack=2 k_eSecondaryAttack value
         * @property {number} k_eZoom=3 k_eZoom value
         * @property {number} k_eReload=4 k_eReload value
         * @property {number} k_eGrenadeThrow=5 k_eGrenadeThrow value
         * @property {number} k_eGrenadeHold=6 k_eGrenadeHold value
         * @property {number} k_eGrenadeHoldThenThrow=7 k_eGrenadeHoldThenThrow value
         */
        CSGOUserCmdPB.EWeaponDecision = (function() {
            var valuesById = {}, values = Object.create(valuesById);
            values[valuesById[0] = "k_eNone"] = 0;
            values[valuesById[1] = "k_ePrimaryAttack"] = 1;
            values[valuesById[2] = "k_eSecondaryAttack"] = 2;
            values[valuesById[3] = "k_eZoom"] = 3;
            values[valuesById[4] = "k_eReload"] = 4;
            values[valuesById[5] = "k_eGrenadeThrow"] = 5;
            values[valuesById[6] = "k_eGrenadeHold"] = 6;
            values[valuesById[7] = "k_eGrenadeHoldThenThrow"] = 7;
            return values;
        })();
    
        /**
         * EGrenadeStrength enum.
         * @name CSGOUserCmdPB.EGrenadeStrength
         * @enum {number}
         * @property {number} k_eLow=0 k_eLow value
         * @property {number} k_eMid=1 k_eMid value
         * @property {number} k_eHigh=2 k_eHigh value
         */
        CSGOUserCmdPB.EGrenadeStrength = (function() {
            var valuesById = {}, values = Object.create(valuesById);
            values[valuesById[0] = "k_eLow"] = 0;
            values[valuesById[1] = "k_eMid"] = 1;
            values[valuesById[2] = "k_eHigh"] = 2;
            return values;
        })();
