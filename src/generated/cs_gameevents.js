...
(function(global, factory) { /* global define, require, module */
    ...
    $root.CMsgTEPlayerAnimEvent = (function() {
         ...
         */
        CMsgTEPlayerAnimEvent.decode = function decode(reader, length) {
    ...
    $root.CMsgTERadioIcon = (function() {
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CMsgTERadioIcon.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
    ...
    $root.CMsgTEFireBullets = (function() {
         ...
         * @property {number|null} [weaponId] CMsgTEFireBullets weaponId
         ...
         * @property {number|null} [recoilIndex] CMsgTEFireBullets recoilIndex
         * @property {number|null} [spread] CMsgTEFireBullets spread
         * @property {number|null} [soundType] CMsgTEFireBullets soundType
         * @property {number|null} [itemDefIndex] CMsgTEFireBullets itemDefIndex
         * @property {number|null} [soundDspEffect] CMsgTEFireBullets soundDspEffect
         * @property {ICMsgVector|null} [entOrigin] CMsgTEFireBullets entOrigin
         * @property {number|null} [numBulletsRemaining] CMsgTEFireBullets numBulletsRemaining
         * @property {number|null} [attackType] CMsgTEFireBullets attackType
         */
        ...
        /**
         * CMsgTEFireBullets weaponId.
         * @member {number} weaponId
         * @memberof CMsgTEFireBullets
         * @instance
         */
        CMsgTEFireBullets.prototype.weaponId = 16777215;
        ...
        /**
         * CMsgTEFireBullets recoilIndex.
         * @member {number} recoilIndex
         * @memberof CMsgTEFireBullets
         * @instance
         */
        CMsgTEFireBullets.prototype.recoilIndex = 0;
        ...
        /**
         * CMsgTEFireBullets soundType.
         * @member {number} soundType
         * @memberof CMsgTEFireBullets
         * @instance
         */
        CMsgTEFireBullets.prototype.soundType = 0;
    
        /**
         * CMsgTEFireBullets itemDefIndex.
         * @member {number} itemDefIndex
         * @memberof CMsgTEFireBullets
         * @instance
         */
        CMsgTEFireBullets.prototype.itemDefIndex = 0;
    
        /**
         * CMsgTEFireBullets soundDspEffect.
         * @member {number} soundDspEffect
         * @memberof CMsgTEFireBullets
         * @instance
         */
        CMsgTEFireBullets.prototype.soundDspEffect = 0;
    
        /**
         * CMsgTEFireBullets entOrigin.
         * @member {ICMsgVector|null|undefined} entOrigin
         * @memberof CMsgTEFireBullets
         * @instance
         */
        CMsgTEFireBullets.prototype.entOrigin = null;
    
        /**
         * CMsgTEFireBullets numBulletsRemaining.
         * @member {number} numBulletsRemaining
         * @memberof CMsgTEFireBullets
         * @instance
         */
        CMsgTEFireBullets.prototype.numBulletsRemaining = 0;
    
        /**
         * CMsgTEFireBullets attackType.
         * @member {number} attackType
         * @memberof CMsgTEFireBullets
         * @instance
         */
        CMsgTEFireBullets.prototype.attackType = 0;
        ...
        CMsgTEFireBullets.encode = function encode(message, writer) {
            ...
            if (message.weaponId != null && Object.hasOwnProperty.call(message, "weaponId"))
                writer.uint32(/* id 3, wireType 0 =*/24).uint32(message.weaponId);
            ...
            if (message.recoilIndex != null && Object.hasOwnProperty.call(message, "recoilIndex"))
                writer.uint32(/* id 8, wireType 5 =*/69).float(message.recoilIndex);
            ...
            if (message.soundType != null && Object.hasOwnProperty.call(message, "soundType"))
                writer.uint32(/* id 10, wireType 0 =*/80).int32(message.soundType);
            if (message.itemDefIndex != null && Object.hasOwnProperty.call(message, "itemDefIndex"))
                writer.uint32(/* id 11, wireType 0 =*/88).uint32(message.itemDefIndex);
            if (message.soundDspEffect != null && Object.hasOwnProperty.call(message, "soundDspEffect"))
                writer.uint32(/* id 12, wireType 5 =*/101).fixed32(message.soundDspEffect);
            if (message.entOrigin != null && Object.hasOwnProperty.call(message, "entOrigin"))
                $root.CMsgVector.encode(message.entOrigin, writer.uint32(/* id 13, wireType 2 =*/106).fork()).ldelim();
            if (message.numBulletsRemaining != null && Object.hasOwnProperty.call(message, "numBulletsRemaining"))
                writer.uint32(/* id 14, wireType 0 =*/112).uint32(message.numBulletsRemaining);
            if (message.attackType != null && Object.hasOwnProperty.call(message, "attackType"))
                writer.uint32(/* id 15, wireType 0 =*/120).uint32(message.attackType);
            return writer;
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CMsgTEFireBullets.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            ...
            while (reader.pos < end) {
                ...
                case 13: {
                        message.entOrigin = $root.CMsgVector.decode(reader, reader.uint32());
                        break;
                    }
                case 14: {
        ...
        CMsgTEFireBullets.verify = function verify(message) {
            ...
            if (message.recoilIndex != null && message.hasOwnProperty("recoilIndex"))
                if (typeof message.recoilIndex !== "number")
                    return "recoilIndex: number expected";
            ...
            if (message.soundDspEffect != null && message.hasOwnProperty("soundDspEffect"))
                if (!$util.isInteger(message.soundDspEffect))
                    return "soundDspEffect: integer expected";
            if (message.entOrigin != null && message.hasOwnProperty("entOrigin")) {
                var error = $root.CMsgVector.verify(message.entOrigin);
                if (error)
                    return "entOrigin." + error;
            }
            if (message.numBulletsRemaining != null && message.hasOwnProperty("numBulletsRemaining"))
                if (!$util.isInteger(message.numBulletsRemaining))
                    return "numBulletsRemaining: integer expected";
        ...
        CMsgTEFireBullets.fromObject = function fromObject(object) {
            ...
            if (object.weaponId != null)
                message.weaponId = object.weaponId >>> 0;
            if (object.mode != null)
            ...
            if (object.recoilIndex != null)
                message.recoilIndex = Number(object.recoilIndex);
            ...
            if (object.soundDspEffect != null)
                message.soundDspEffect = object.soundDspEffect >>> 0;
            if (object.entOrigin != null) {
                if (typeof object.entOrigin !== "object")
                    throw TypeError(".CMsgTEFireBullets.entOrigin: object expected");
                message.entOrigin = $root.CMsgVector.fromObject(object.entOrigin);
            }
            if (object.numBulletsRemaining != null)
        ...
        CMsgTEFireBullets.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                object.origin = null;
                object.angles = null;
                object.weaponId = 16777215;
                object.mode = 0;
                object.seed = 0;
                object.player = 16777215;
                object.inaccuracy = 0;
                object.recoilIndex = 0;
                object.spread = 0;
                object.soundType = 0;
                object.itemDefIndex = 0;
                object.soundDspEffect = 0;
                object.entOrigin = null;
                object.numBulletsRemaining = 0;
                object.attackType = 0;
            }
            if (message.origin != null && message.hasOwnProperty("origin"))
            ...
            if (message.recoilIndex != null && message.hasOwnProperty("recoilIndex"))
                object.recoilIndex = options.json && !isFinite(message.recoilIndex) ? String(message.recoilIndex) : message.recoilIndex;
            if (message.spread != null && message.hasOwnProperty("spread"))
            ...
            if (message.soundDspEffect != null && message.hasOwnProperty("soundDspEffect"))
                object.soundDspEffect = message.soundDspEffect;
            if (message.entOrigin != null && message.hasOwnProperty("entOrigin"))
                object.entOrigin = $root.CMsgVector.toObject(message.entOrigin, options);
            if (message.numBulletsRemaining != null && message.hasOwnProperty("numBulletsRemaining"))
                object.numBulletsRemaining = message.numBulletsRemaining;
            if (message.attackType != null && message.hasOwnProperty("attackType"))
         ...
         * @returns {string} The default type url
         */
        CMsgTEFireBullets.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/CMsgTEFireBullets";
        };
