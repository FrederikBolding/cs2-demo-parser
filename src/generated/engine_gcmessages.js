...
(function(global, factory) { /* global define, require, module */
    ...
    $root.CEngineGotvSyncPacket = (function() {
         ...
         * @property {number|Long|null} [matchId] CEngineGotvSyncPacket matchId
         * @property {number|null} [instanceId] CEngineGotvSyncPacket instanceId
         ...
         * @property {number|null} [keyframeInterval] CEngineGotvSyncPacket keyframeInterval
         ...
         * @instance
         */
        CEngineGotvSyncPacket.prototype.matchId = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
         ...
         * @instance
         */
        CEngineGotvSyncPacket.prototype.instanceId = 0;
         ...
         * @instance
         */
        CEngineGotvSyncPacket.prototype.keyframeInterval = 0;
        ...
        CEngineGotvSyncPacket.encode = function encode(message, writer) {
            ...
            if (message.keyframeInterval != null && Object.hasOwnProperty.call(message, "keyframeInterval"))
                writer.uint32(/* id 10, wireType 5 =*/85).float(message.keyframeInterval);
        ...
        CEngineGotvSyncPacket.verify = function verify(message) {
            ...
            if (message.keyframeInterval != null && message.hasOwnProperty("keyframeInterval"))
                if (typeof message.keyframeInterval !== "number")
                    return "keyframeInterval: number expected";
        ...
        CEngineGotvSyncPacket.fromObject = function fromObject(object) {
            ...
            if (object.keyframeInterval != null)
                message.keyframeInterval = Number(object.keyframeInterval);
        ...
        CEngineGotvSyncPacket.toObject = function toObject(message, options) {
            ...
            if (message.keyframeInterval != null && message.hasOwnProperty("keyframeInterval"))
                object.keyframeInterval = options.json && !isFinite(message.keyframeInterval) ? String(message.keyframeInterval) : message.keyframeInterval;
            if (message.cdndelay != null && message.hasOwnProperty("cdndelay"))
